...
public class Orders_Completed_fragment extends Fragment implements View.OnClickListener{
    private RecyclerView recyclerView;
    private AQuery aQuery;
    private List<Orders_Recycler_DataCollect> ListData;
    private Orders_Completed_fragment.MyAdapter mAdapter;
            ...
            aQuery.progress(progressDialog).ajax(url, null, JSONObject.class, new AjaxCallback<JSONObject>() {
                ...
                public void callback(String url, JSONObject json, AjaxStatus status) {
                    if (json != null) {
                        ...
                        mAdapter = new Orders_Completed_fragment.MyAdapter();
    ...
    public class MyAdapter extends RecyclerView.Adapter<Orders_Completed_fragment.MyAdapter.ViewHolder> {

        @Override
        public Orders_Completed_fragment.MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemLayoutView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.orders_recycler,parent,false);
            Orders_Completed_fragment.MyAdapter.ViewHolder viewHolder = new Orders_Completed_fragment.MyAdapter.ViewHolder(itemLayoutView);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(Orders_Completed_fragment.MyAdapter.ViewHolder viewHolder, int position) {
...
*/
        ...
        @Override
        public void onViewDetachedFromWindow(Orders_Completed_fragment.MyAdapter.ViewHolder holder) {
