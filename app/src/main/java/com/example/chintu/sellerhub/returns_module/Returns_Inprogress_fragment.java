...
import com.example.chintu.sellerhub.orders_module.Orders_ConversionHelper;
...
public class Returns_Inprogress_fragment extends Fragment implements View.OnClickListener{
    private RecyclerView recyclerView;
    private AQuery aQuery;
    private List<Returns_Recycler_DataCollect> ListData;
    private Returns_Inprogress_fragment.MyAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.returns_listing, container, false);
        aQuery = new AQuery(getActivity());

        recyclerView = (RecyclerView) v.findViewById(R.id.recycler_view_returns);
        ...
        if (isConnection()) {
            ...
            aQuery.progress(progressDialog).ajax(url, null, JSONObject.class, new AjaxCallback<JSONObject>() {
                ...
                public void callback(String url, JSONObject json, AjaxStatus status) {
                    if (json != null) {
                        ListData = Returns_ConversionHelper.getcomment(json);
                        mAdapter = new Returns_Inprogress_fragment.MyAdapter();
    ...
    public class MyAdapter extends RecyclerView.Adapter<Returns_Inprogress_fragment.MyAdapter.ViewHolder> {

        @Override
        public Returns_Inprogress_fragment.MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemLayoutView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.returns_recycler,parent,false);
            Returns_Inprogress_fragment.MyAdapter.ViewHolder viewHolder = new Returns_Inprogress_fragment.MyAdapter.ViewHolder(itemLayoutView);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(Returns_Inprogress_fragment.MyAdapter.ViewHolder viewHolder, int position) {

            // MallsListBean storeBean = mallsList.get(position);
            final Returns_Recycler_DataCollect tutorListBeans = ListData.get(position);

            viewHolder.title.setText(String.valueOf(tutorListBeans.getTitle()));
            viewHolder.ID.setText(String.valueOf(tutorListBeans.getArtwork_id()));
            viewHolder.Price.setText(tutorListBeans.getSelling_price());
            viewHolder.ReturnType.setText(String.valueOf(tutorListBeans.getReturn_type()));
            viewHolder.Requested_On.setText(String.valueOf(tutorListBeans.getRequested_on()));
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("artwork_id", String.valueOf(tutorListBeans.getReturn_id()));
...
*/
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            protected TextView Requested_On;
            protected TextView ReturnType;
            ...
            public ViewHolder(final View itemLayoutView) {
                ...
                ReturnType = (TextView) itemLayoutView.findViewById(R.id.return_type_recycler);
                image = (NetworkImageView) itemLayoutView.findViewById(R.id.artwork_image_recycler);
                Requested_On = (TextView) itemLayoutView.findViewById(R.id.return_request_recycler);
        ...
        @Override
        public void onViewDetachedFromWindow(Returns_Inprogress_fragment.MyAdapter.ViewHolder holder) {
