...
public class Returns_Completed_fragment extends Fragment implements View.OnClickListener{
    private RecyclerView recyclerView;
    private AQuery aQuery;
    private List<Returns_Recycler_DataCollect> ListData;
    private Returns_Completed_fragment.MyAdapter mAdapter;
            ...
            aQuery.progress(progressDialog).ajax(url, null, JSONObject.class, new AjaxCallback<JSONObject>() {
                ...
                public void callback(String url, JSONObject json, AjaxStatus status) {
                    if (json != null) {
                        ...
                        mAdapter = new Returns_Completed_fragment.MyAdapter();
    ...
    public class MyAdapter extends RecyclerView.Adapter<Returns_Completed_fragment.MyAdapter.ViewHolder> {

        @Override
        public Returns_Completed_fragment.MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemLayoutView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.returns_recycler,parent,false);
            Returns_Completed_fragment.MyAdapter.ViewHolder viewHolder = new Returns_Completed_fragment.MyAdapter.ViewHolder(itemLayoutView);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(Returns_Completed_fragment.MyAdapter.ViewHolder viewHolder, int position) {
...
*/
        ...
        @Override
        public void onViewDetachedFromWindow(Returns_Completed_fragment.MyAdapter.ViewHolder holder) {
